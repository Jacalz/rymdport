...
- A couple changes for faster send and receive of directories.
  - Filepaths are not cleaned twice for each file on send.
  - The zip decompresser is no longer recreated on each receive.
